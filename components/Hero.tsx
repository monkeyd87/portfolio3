...
export const Hero = ()=>{
    return(
        <div className="hero pb-20 pt-36 ">
            ...
            <div className="absolute top-0 left-0  h-screen w-full flex items-center justify-center bg-black">
                <div
                    className={cn(
                    "absolute inset-0",
            ...
            <div className="flex  justify-center  relative   z-10 ">
                    <div className="max-w-[100vw] md:max-w-2xl lg:max-w-100 flex flex-col items-center justify-center">
                        ...
                        <TextGenerateEffect
                                ...
                                words="Transforming concepts in seamless user experince"
                        />
                        <p className="text-center md:tracking-wider mb-4 md:text-lg lg:text-2xl">Hi, I&apos;m a Full-stack developer from Sacramento </p>
                        <a href="#about">
